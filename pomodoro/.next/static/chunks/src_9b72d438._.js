...
"[project]/src/components/ui/pomodoroTimer/index.tsx [app-client] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
const PomodoroTimer = ()=>{
    ...
    const [shortBreakMinutes, setShortBreakMinutes] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(5);
    const [longBreakMinutes, setLongBreakMinutes] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(15);
    ...
    const [voicePlayed, setVoicePlayed] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(false);
    ...
    const [workVideoUrl, setWorkVideoUrl] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])("https://www.youtube.com/watch?v=HuFYqnbVbzY");
    const [breakVideoUrl, setBreakVideoUrl] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])("https://www.youtube.com/watch?v=g1Ziw1lhzeU");
    ...
    const { seconds, minutes, isRunning, start, pause, restart } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$timer$2d$hook$2f$dist$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useTimer"])({
        expiryTimestamp: expiry(25 * 60),
        autoStart: false,
        onExpire: {
            "PomodoroTimer.useTimer": ()=>handleExpire()
        }["PomodoroTimer.useTimer"]
    });
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "PomodoroTimer.useEffect": ()=>{
            const videoUrl = mode === "work" ? getYoutubeEmbedUrl(workVideoUrl) : getYoutubeEmbedUrl(breakVideoUrl);
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "PomodoroTimer.useEffect": ()=>{
            const loadSettings = {
                "PomodoroTimer.useEffect.loadSettings": async ()=>{
                    try {
            ...
            }["PomodoroTimer.useEffect.loadSettings"];
            loadSettings();
        }
    }["PomodoroTimer.useEffect"], []);
    const saveSettings = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])((0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$lodash$2e$debounce$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"])({
        "PomodoroTimer.useCallback[saveSettings]": (settings)=>{
            localStorage.setItem("pomodoroSettings", JSON.stringify(settings));
            console.log("Saved settings (debounced)", settings);
        }
    }["PomodoroTimer.useCallback[saveSettings]"], 500), []);
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "PomodoroTimer.useEffect": ()=>{
            saveSettings({
                workMinutes,
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "PomodoroTimer.useEffect": ()=>{
            if (!isRunning && !isFirstLoad) {
                const secs = mode === "work" ? workMinutes * 60 : mode === "shortBreak" ? shortBreakMinutes * 60 : longBreakMinutes * 60;
    ...
    const handleExpire = async ()=>{
        ...
        if (mode === "work") {
            ...
            const nextMinutes = nextMode === "longBreak" ? longBreakMinutes : shortBreakMinutes;
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "PomodoroTimer.useEffect": ()=>{
            const playAudio = {
                "PomodoroTimer.useEffect.playAudio": async ()=>{
                    if (!audioRef.current) {
            ...
            }["PomodoroTimer.useEffect.playAudio"];
            playAudio();
        }
    }["PomodoroTimer.useEffect"], [
        mode
    ...
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
        className: "max-w-md mx-auto p-4 text-center",
        children: [
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("h1", {
                className: "text-2xl font-bold mb-4",
                children: "Pomodoro Timer"
            }, void 0, false, {
                fileName: "[project]/src/components/ui/pomodoroTimer/index.tsx",
                lineNumber: 218,
                columnNumber: 7
            }, this),
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                ...
                children: [
                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("span", {
                        className: "text-xl",
                        children: mode === "work" ? "Work" : mode === "shortBreak" ? "Break" : "Long Break"
                    }, void 0, false, {
                        fileName: "[project]/src/components/ui/pomodoroTimer/index.tsx",
                        lineNumber: 221,
                        columnNumber: 9
            ...
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                className: "my-4 space-y-2 text-sm",
                children: [
                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("label", {
                        className: "block",
                        children: [
                    ...
                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$ui$2f$button$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Button"], {
                        ...
                        onClick: ()=>{
                            if (iframeRef.current) {
                                iframeRef.current.src = mode === "work" ? getYoutubeEmbedUrl(workVideoUrl) : getYoutubeEmbedUrl(breakVideoUrl);
                            }
                        },
                        children: "Play Video"
                    }, void 0, false, {
...
_s(PomodoroTimer, "HIkKmGbN/pR3OXYEt0OG7/in69I=", false, function() {
    return [
...
_c = PomodoroTimer;
const __TURBOPACK__default__export__ = PomodoroTimer;
var _c;
...
//# sourceMappingURL=src_9b72d438._.js.map